        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maximumchargingsupport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Batterytechnology = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectionChargingPort = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sizevolume = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Launchtime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Thefirm = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remainingcapacityisapproximately = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Phonebook = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "OperatingSystemsAndCPUs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Operatingsystem = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Processorchip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperatingSystemsAndCPUs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Flashlight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Feature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Resolution = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Widescreen = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Maximumbrightness = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Touchglasssurface = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Advancedsecurity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Specialfeatures = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Wateranddustresistant = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Record = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Watchamovie = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Listeningtomusic = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgUrlMain = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemoryandStorageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductDetails_MemoryAndStorages_MemoryandStorageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontcameraId = table.Column<int>(type: "int", nullable: false),
                    OperatingSystemandCPUId = table.Column<int>(type: "int", nullable: false),
                    ConnectId = table.Column<int>(type: "int", nullable: false),
                    BatteryandChargerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specifications_BatteryandChargers_BatteryandChargerId",
                        column: x => x.BatteryandChargerId,
                        principalTable: "BatteryandChargers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_Connects_ConnectId",
                        column: x => x.ConnectId,
                        principalTable: "Connects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_FrontCameras_FrontcameraId",
                        column: x => x.FrontcameraId,
                        principalTable: "FrontCameras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_GeneralInformations_GeneralinformationId",
                        column: x => x.GeneralinformationId,
                        principalTable: "GeneralInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_OperatingSystemsAndCPUs_OperatingSystemandCPUId",
                        column: x => x.OperatingSystemandCPUId,
                        principalTable: "OperatingSystemsAndCPUs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_RearCameras_RearcameraId",
                        column: x => x.RearcameraId,
                        principalTable: "RearCameras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_Screens_ScreenId",
                        column: x => x.ScreenId,
                        principalTable: "Screens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specifications_Utilities_UtilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comment_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "ProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Favorites_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "ProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoicesDetails_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "ProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductViews_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "ProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Ratings_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Ratings_InvoicesDetails_InvoiceDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_ProductDetailId",
                table: "Favorites",
                column: "ProductDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicesDetails_ProductDetailId",
                table: "InvoicesDetails",
                column: "ProductDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDetails_MemoryandStorageId",
                table: "ProductDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductViews_ProductDetailId",
                table: "ProductViews",
                column: "ProductDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_InvoiceDetailId",
                table: "Ratings",
                column: "InvoiceDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_InvoiceId",
                table: "Ratings",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specifications_BatteryandChargerId",
                table: "Specifications",
                column: "BatteryandChargerId");

            migrationBuilder.CreateIndex(
                name: "IX_Specifications_ConnectId",
                table: "Specifications",
                column: "ConnectId");

            migrationBuilder.CreateIndex(
                name: "IX_Specifications_FrontcameraId",
                table: "Specifications",
                column: "FrontcameraId");

            migrationBuilder.CreateIndex(
                name: "IX_Specifications_GeneralinformationId",
                table: "Specifications",
                column: "GeneralinformationId");

            migrationBuilder.CreateIndex(
                name: "IX_Specifications_OperatingSystemandCPUId",
                table: "Specifications",
                column: "OperatingSystemandCPUId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specifications_RearcameraId",
                table: "Specifications",
                column: "RearcameraId");

            migrationBuilder.CreateIndex(
                name: "IX_Specifications_ScreenId",
                table: "Specifications",
                column: "ScreenId");

            migrationBuilder.CreateIndex(
                name: "IX_Specifications_UtilityId",
                table: "Specifications",
                column: "UtilityId");
        }
