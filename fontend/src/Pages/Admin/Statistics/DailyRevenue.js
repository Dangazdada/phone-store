...
const DailyRevenue = () => {
  ...
  const columns =  [
    ...
    },
    {
      ...
      key: 'dailyRevenue',
      render: (dailySubTotal) => (
        dailySubTotal.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })
      )
     
    },
    // {
    //   title: 'Tiền hàng (giá nhập)',
    //   dataIndex: 'dailyCapital',
    //   key: 'dailyCapital',
    //   render: (dailyCapital) => (
    //     dailyCapital.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })
    //   )
    ...
    //   key: 'dailyCapital',
    //   render: (text, record) => {
    //     const dailySell =  parseInt(record.dailySell);
    //     const dailyCapital = parseInt(record.dailyCapital);
    ...
    //    // Hoặc giá trị mặc định khi không thể tính toán được
    //   }
    // },
    {
      title: 'Chức năng',
  ...
  const columnsDetail = [
    ...
    //   key: 'capital',
    //   render: (capital) => (
    //     capital.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })
    //   )
    ...
    //   key: 'capital',
    //   render: (text, record) => {
    //     const Sell =  parseInt(record.total);
    //     const Capital = parseInt(record.capital);
